...
<html lang="it">
    ...
    <div class="container">
    	<div class="page-header">
        	<center><h1><font color="#FF0000">CALCOLATRICE DI PRODOTTO</font></h1></center>
        </div>
    <div class="media-middle">
        <div class="col-md-6">
        	<div class="jumbotron">
            	<form method="get" action="../Upload_Download/Upload_Download.php?ID_PRODUCT=<?php print("$Id_Product"); ?>&Amount=&Price=&Discount=" autocomplete="on">
                	<div class="form-group" align="center">
                    	<fieldset>
                            ...
                            <input type="text" class="form-control" name="Amount" placeholder="Inserisci quantità(solo dati numerici interi)">
                            <label for="Giacenz">Prezzo</label>
                            <input type="text" class="form-control" name="Price" placeholder="Inserisci prezzo">
														<label for="Discount">Sconto</label>
														<input type="text" class="form-control" name="Discount" placeholder="Inserisci sconto">
                            <br>
                            <div class="dropdown">
							  ...
							  ?>
                                <li id="Product"><a href="Calc_Goods.php?ID_PRODUCT=<?php print($Assoc['ID_PRODUCT']); ?>"><?php print($Assoc['DESCRIPTION']); ?></a></li>
                                <?php } mysqli_close($db); ?>
                              </ul>
                            </div>
                            <br>
